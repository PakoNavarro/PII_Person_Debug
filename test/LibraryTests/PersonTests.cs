...
namespace Ucu.Poo.Persons.Tests
{
    ...
    public class PersonTests
    {
        ...
        public void TestProperties()
        {
            ...
            Assert.That(person.FamilyName, Is.EqualTo(familyName));
            ...
            Assert.That(person.FamilyName, Is.EqualTo(anotherFamilyName));
        }
        ...
        public void TestFullName()
        {
            ...
            Assert.That(person.FullName, Is.EqualTo(fullName));
        }
